...
<div class="container mt-4 flex-grow-1">
    ...
    <h2 class="text-center fs-1 mb-4">Lecturer List</h2>
        ...
        <tbody>
            <?php foreach ($lecturers as $row) : ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=lecturer&action=edit&id=<?= $row['id'] ?>" 
                           class="btn btn-secondary btn-sm">Edit</a>

                        <a href="index.php?page=lecturer&action=delete&id=<?= $row['id'] ?>" 
    ...
    <a href="index.php?page=lecturer&action=create" 
